  ...
  <div>
    ...
    <dropdown fullWidth class="dropdown-axis" v-if="isXAxis"
      ...
      <div class="display-flex margin-bottom-4-1">
        <img src="../assets/icons/y-axis/kunstig-intelligens-big-data-og-robotter-darkyellow.png" :style="{ minWidth: '75px' }" height="75px" alt="Ikon for kunstig intelligens, big data og robotter">
      ...
      <div class="display-flex margin-bottom-4-1">
        <img src="../assets/icons/y-axis/internet-of-things-darkyellow.png" :style="{ minWidth: '75px' }" height="75px" alt="Ikon for kunstig intelligens, big data og robotter">
        <div class="margin-left-3-1">
      ...
      <div class="display-flex margin-bottom-4-1">
        <img src="../assets/icons/y-axis/virtual-reality-og-augmented-reality-darkyellow.png" :style="{ minWidth: '75px' }" height="75px" alt="Ikon for kunstig intelligens, big data og robotter">
        <div class="margin-left-3-1">
      ...
      <div class="display-flex margin-bottom-4-1">
        <img src="../assets/icons/y-axis/deleokonomi-og-blockchain-darkyellow.png" :style="{ minWidth: '75px' }" height="75px" alt="Ikon for kunstig intelligens, big data og robotter">
        <div class="margin-left-3-1">
      ...
      <div class="display-flex margin-bottom-4-1">
        <img src="../assets/icons/y-axis/data-privatliv-transparens-og-sikkerhed-darkyellow.png" :style="{ minWidth: '75px' }" height="75px" alt="Ikon for kunstig intelligens, big data og robotter">
        <div class="margin-left-3-1">
